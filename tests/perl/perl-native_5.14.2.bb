...
do_install () {
	...
	ln -sf .${NATIVE_PACKAGE_PATH_SUFFIX}/perl${PV} ${D}${bindir}/perl${PV}
	# We need a hostperl link for building perl
	ln -sf .${NATIVE_PACKAGE_PATH_SUFFIX}/perl${PV} ${D}${bindir}/hostperl
	...
	create_wrapper ${D}${bindir}/${NATIVE_PACKAGE_PATH_SUFFIX}/perl PERL5LIB='$PERL5LIB:${STAGING_LIBDIR}/perl/${PV}:${STAGING_LIBDIR}/perl/'
	create_wrapper ${D}${bindir}/${NATIVE_PACKAGE_PATH_SUFFIX}/perl${PV} PERL5LIB='$PERL5LIB:${STAGING_LIBDIR}/perl/${PV}:${STAGING_LIBDIR}/perl/'
}
